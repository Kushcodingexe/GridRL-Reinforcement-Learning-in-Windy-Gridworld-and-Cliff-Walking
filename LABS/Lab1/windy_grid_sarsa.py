...
import sys
sys.path.append(r'c:\Users\Kush\My Drive\RL\LABS\Lab1')
...
# Calculate and print the average number of steps for SARSA
average_steps_sarsa = sum(steps_sarsa) / len(steps_sarsa)
print(f'Average number of steps for SARSA: {average_steps_sarsa}')
...
# Calculate and print the average number of steps for Q-learning
average_steps_qlearn = sum(steps_qlearn) / len(steps_qlearn)
print(f'Average number of steps for Q-learning: {average_steps_qlearn}')